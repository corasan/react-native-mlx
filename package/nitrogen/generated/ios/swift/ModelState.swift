...
/**
 * Represents an instance of `ModelState`, backed by a C++ struct.
 */
public typealias ModelState = margelo.nitro.rnmlx.ModelState

public extension ModelState {
  private typealias bridge = margelo.nitro.rnmlx.bridge.swift

  /**
   * Create a new instance of `ModelState`.
   */
