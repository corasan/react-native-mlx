...
namespace margelo::nitro::rnmlx::bridge::swift {
  ...
  /**
   * Specialized version of `std::shared_ptr<margelo::nitro::rnmlx::HybridLLMEvaluatorSpec>`.
   */
  using std__shared_ptr_margelo__nitro__rnmlx__HybridLLMEvaluatorSpec_ = std::shared_ptr<margelo::nitro::rnmlx::HybridLLMEvaluatorSpec>;
  ...
  // pragma MARK: std::weak_ptr<margelo::nitro::rnmlx::HybridLLMEvaluatorSpec>
  using std__weak_ptr_margelo__nitro__rnmlx__HybridLLMEvaluatorSpec_ = std::weak_ptr<margelo::nitro::rnmlx::HybridLLMEvaluatorSpec>;
  inline std__weak_ptr_margelo__nitro__rnmlx__HybridLLMEvaluatorSpec_ weakify_std__shared_ptr_margelo__nitro__rnmlx__HybridLLMEvaluatorSpec_(const std::shared_ptr<margelo::nitro::rnmlx::HybridLLMEvaluatorSpec>& strong) { return strong; }
